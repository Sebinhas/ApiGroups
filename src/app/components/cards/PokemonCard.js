      ...
      <div className="w-full flex flex-col">
         <div className="relative flex flex-col w-full min-w-[300px] max-w-[360px] h-[200px] backImgPokemon rounded-t-[20px]">
            <div className="flex justify-between w-full absolute px-2 py-3 top-0 ">
               ...
               <div
                  className={`uppercase flex justify-center items-center w-20 ${background} font-semibold text-slate-100 text-[14px] rounded-full`}
               >
                  {data.type[0]}
               </div>
            </div>
            ...
            <div
               className={`flex justify-center items-center min-w[300px] max-w-[360px] h-[200px] ${background} bg-opacity-[0.4] rounded-t-[20px]`}
            >
               <div className="w-40">
                  <Image
                     width={160}
         ...
         <div className="relative w-full">
            <div
               className={`flex justify-center items-center absolute left-9 top-[-20px]  w-56  h-10 rounded-full ${background} ${text} `}
            >
               <div
         ...
         <div
            className={`w-full flex justify-center items-center ${background2} pt-9 pb-5 rounded-b-[20px]`}
         >
            <div
               className={`flex justify-center items-center border-[3px] rounded-3xl ${border} `}
            >
               <div className="flex justify-between items-center gap-10 font-bold py-5 px-3 ">
                  <div
                     className={`uppercase flex flex-col gap-y-1 items-center ${text} `}
                  >
                     <div>weakness</div>
                     <div>abilities</div>
                     <div>weight</div>
